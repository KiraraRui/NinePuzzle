...
public class dragAndDropListener extends GridView {
    ...
    public dragAndDropListener(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public dragAndDropListener(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(final Context context) {
        gDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                                   float velocityY) {
                final int position = dragAndDropListener.this.pointToPosition
